...
export const hero = {
  ...
  body: "Govern AI actions from policy to proof. Enigma decides whether an AI-mediated action may proceed under enterprise policy, enforces that decision on the request path, routes exceptions to an authorized approver, and produces evidence of what was decided.",
